...
The resulting ZIP is written to `artifacts/Inboxwell-1.4.11-win-x64-installer.zip`. Extract it and run `Install-Inboxwell.ps1`. The included development certificate is intended only for builds you created or received from a trusted source.
